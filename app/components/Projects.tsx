            ...
            <div className="container !mx-auto text-white">
                ...
                <div className='flex flex-wrap justify-center relative gap-14'>
                    ...
                    data-aos-duration="1000" data-aos-easing="ease-out">
                        ...
                        className='md:w-[350px] w-[80%] relative bg-secondary-light-clr hover:bg-[#16202b] !pt-[26px] !pb-[90px] !px-5 rounded-lg z-[100]'>
                    ...
                    data-aos-duration="1000" data-aos-easing="ease-out">
                        <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} scale={1.02} className='md:w-[350px] w-[80%] relative bg-secondary-light-clr hover:bg-[#16202b] !pt-[26px] !pb-[90px] !px-5 rounded-lg z-[100]'>
                    ...
                    data-aos-duration="1000" data-aos-easing="ease-out">
                        <Tilt tiltMaxAngleX={5} tiltMaxAngleY={5} scale={1.02} className='md:w-[350px] w-[80%] relative bg-secondary-light-clr hover:bg-[#16202b] !pt-[26px] !pb-[90px] !px-5 rounded-lg z-[1000]'>
