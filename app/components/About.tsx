    ...
    return (
        <div className='w-full h-full bg-main-dark-clr lg:!pt-60 md:!py-50 !py-40 relative'>
            <div className='container !mx-auto justify-items-center'>
                <h2 className='text-5xl font-semibold text-white text-center' data-aos="fade-up" data-aos-duration="700" data-aos-easing="ease-out">About</h2>
                <p className='text-[18px] text-white !mt-6 w-[80%] text-center' data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-out">
